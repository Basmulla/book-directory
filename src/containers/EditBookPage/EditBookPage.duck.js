...
export const fetchBook = id => (dispatch, getState, axios) => {
    ...
    return axios.get(`https://book-directory-rest-api.herokuapp.com/api/books/${id}`)
...
export const updateBook = params => (dispatch, getState, axios) => {
    ...
    return axios.put(`https://book-directory-rest-api.herokuapp.com/api/books/${isbn}`, updatedValues)
...
export const deleteBook = id => (dispatch, getState, axios) => {
    ...
    return axios.delete(`https://book-directory-rest-api.herokuapp.com/api/books/${id}`)
